...
public class ConsoleUtil {
    ...
    /**
     * Gets a boolean input from the user with yes/no prompt.
     *
     * @param prompt the prompt to display to the user (without yes/no)
     * @return true if user enters yes/y, false otherwise
     */
    public static boolean getUserBooleanInput(String prompt) {
        String input = getUserInput(prompt + " (yes/no): ");

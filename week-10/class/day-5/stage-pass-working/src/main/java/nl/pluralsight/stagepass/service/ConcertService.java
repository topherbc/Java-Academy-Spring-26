...
public class ConcertService {
    ...
    // FEAT-02: concerts for a specific artist (empty list if none)
    ...
    // FEAT-04: seats sold, seats remaining, and total revenue for a concert
    public Optional<ConcertSummary> getConcertSummary(Long id) {
